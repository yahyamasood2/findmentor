...
!(function(e) {
	'function' == typeof define && define.amd
		? define([ 'jquery' ], e)
		: 'object' == typeof module && module.exports ? e(require('jquery')) : e(jQuery);
})(function(g, a) {
	'use strict';
	var t = {
	...
	function o(e, s) {
		...
		if (!1 === a) {
			...
			if (
				...
				o = v(t, s.progressOrder, s.progressAutoResize, s.progressResizeFactor, !1).addClass(
		...
		return (
			...
			('string' == typeof e && -1 < [ 'vmin', 'vmax' ].indexOf(e.slice(-4))
				...
				: 'string' == typeof e && -1 < [ 'rem' ].indexOf(e.slice(-3))
					...
					: 'string' == typeof e &&
						-1 < [ 'px', 'em', 'cm', 'mm', 'in', 'pt', 'pc', 'vh', 'vw' ].indexOf(e.slice(-2))
